    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 12,
                "vtp_instanceDestinationId": "G-PNY6DMXXRP",
                "tag_id": 18
            }, {
                ...
                "priority": 2,
                "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"telegram\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"letstalk\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"be_agent\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"fuel_consumption\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"prices_table\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_helper_link\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_nzt_link\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"game_apps_links\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
                "vtp_instanceDestinationId": "G-PNY6DMXXRP",
                "tag_id": 8
            }, {
...
*/
    ...
    Gi.Be = Number("0") || 0;
    Gi.ob = "dataLayer";
    Gi.yn = "ChAI8KbyuAYQhfyCuK6OstoJEiUAL1H0Ca/d/3Lm0eThHVjtuCpmT4URX40+KrEL2/LfNw5A9BA8GgIevg\x3d\x3d";
    var Ii = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;var ck = {}
      ...
      , Nf = {
        ctid: "G-PNY6DMXXRP",
        canonicalContainerId: "184689627",
        jk: "G-PNY6DMXXRP|GT-NNMSMFTG",
        kk: "G-PNY6DMXXRP"
    };
    ck.ye = lb("");
    function ek() {
    ...
    ;var kl;
    try {
        kl = JSON.parse(Sa("eyIwIjoiQ04iLCIxIjoiQ04tNDQiLCIyIjp0cnVlLCIzIjoiZ29vZ2xlLmNuIiwiNCI6IiIsIjUiOnRydWUsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        S(123),
        jl(2),
        kl = {}
    ...
    var Us = function(a) {
      ...
      , Xs = function(a, b, c) {
        ...
        return C.setInterval(Vs(a, b, c), 1E3)
    }
      , Vs = function(a, b, c) {
        function d(k, m) {
            var n = {
      ...
      , Ts = []
      , Ss = !(!C.IntersectionObserver || !C.IntersectionObserverEntry);
    var Zs = function(a) {
    ...
    var BA = function(a, b, c) {
      ...
      , AA = function(a) {
        ...
        return DA.indexOf(b) < 0 || b === "input" && EA.indexOf(a.type.toLowerCase()) >= 0 ? !1 : !0
    }
      , DA = ["input", "select", "textarea"]
      , EA = ["button", "hidden", "image", "reset", "submit"];
    function IA(a) {}
    ...
    var QA = function() {
            ...
            LA.push(function(f) {
                ...
                if (g) {
                    ...
                    if (k) {
                        ...
                        p.Eb.dataset.gtmFormInteractFieldId !== n && RA(p, d)),
                        p.Eb = g,
                        TA(p, d, a)) : (e[m] = {
                            form: k,
                            Eb: g,
      ...
      , RA = function(a, b) {
        ...
        e["gtm.interactedFormFieldPosition"] = BA(c, d, "gtmFormInteractFieldId");
    ...
    function VA(a, b) {
        ...
        if (!d || d < 0)
            d = 0;
        var e = G(a), f;
        uA("pix.fil", "init") ? f = uA("pix.fil", "reg") : (QA(),
        f = UA,
        vA("pix.fil", "reg", UA),
        vA("pix.fil", "init", !0));
        f(d, e);
    ...
    var XA = function(a, b, c) {
      ...
      , YA = function(a, b) {
        var c = uA("pix.fsl", a ? "nv.mwt" : "mwt", 0);
        C.setTimeout(b, c)
    }
      , ZA = function(a, b, c, d, e) {
        var f = uA("pix.fsl", c ? "nv.mwt" : "mwt", 0)
          , g = uA("pix.fsl", c ? "runIfCanceled" : "runIfUncanceled", []);
        if (!g.length)
            return !0;
        var k = XA(a, c, e);
        S(121);
      ...
      , aB = function() {
        ...
        uc(E, "click", function(c) {
            var d = c.target;
            if (d) {
                var e = zc(d, ["button", "input"], 100);
                if (e && (e.type === "submit" || e.type === "image") && e.name && wc(e, "value")) {
                    var f = CA(e);
                    f && a.store(f, e)
                }
            }
        }, !1);
        uc(E, "submit", function(c) {
            var d = c.target;
            if (!d)
    ...
    function bB(a, b) {
        ...
        if (d) {
            ...
            yA("pix.fsl", "mwt", k, 0);
            f || yA("pix.fsl", "nv.mwt", k, 0)
        }
        var m = function(n) {
            n.push(g);
            return n
        };
        yA("pix.fsl", "runIfUncanceled", m, []);
        f || yA("pix.fsl", "runIfCanceled", m, []);
        uA("pix.fsl", "init") || (aB(),
        vA("pix.fsl", "init", !0));
    }
        ...
        if (sC[c])
            ...
            tC.push(function(f) {
                ...
                if (g) {
                    var k = CA(g);
                    if (k) {
                        var m = zC(k, "gtmFormInteractId", function() {
                            return vC++
                        })
                          , n = zC(g, "gtmFormInteractFieldId", function() {
                            return wC++
                        });
                        if (m !== null && n !== null) {
                            var p = e[m];
                            p ? (p.Xb && (C.clearTimeout(p.Xb),
                            p.Eb.getAttribute("data-gtm-form-interact-field-id") !== n && xC(p, d)),
                            p.Eb = g,
                            AC(p, d, b)) : (e[m] = {
                                form: k,
                                Eb: g,
    ...
    var DC = function(a, b, c, d, e) {
        var f = uA("fsl", c ? "nv.mwt" : "mwt", 0), g;
        g = c ? uA("fsl", "nv.ids", []) : uA("fsl", "ids", []);
        if (!g.length)
            return !0;
        var k = zA(a, "gtm.formSubmit", g)
          , m = a.action;
    ...
    function VC(a, b) {
        ...
        if (!uA(d, "init", !1)) {
            var f;
            d === "ehl" ? (f = function(k) {
                for (var m = 0; m < OC.length; m++)
                    OC[m](k)
            }
            ,
            b = tA(b),
            QC(b, e),
            vA(d, "reg", QC)) : f = PC("gtm.historyChange");
            UC(f);
            TC(f);
            RC("pushState", f);
            RC("replaceState", f);
    ...
    var cD = function(a) {
      ...
      , fD = function(a, b) {
        uA("sdl", "init", !1) && !iD() && (b ? vc(C, "scrollend", a) : vc(C, "scroll", a),
        vc(C, "resize", a),
        vA("sdl", "init", !1))
    }
      , eD = function() {
        var a = aD()
          ...
          , d = a.Il
          , e = a.Jl
          , f = (b !== void 0 ? b : d) / bD.scrollWidth * 100
          , g = (c !== void 0 ? c : e) / bD.scrollHeight * 100;
        jD(b !== void 0 ? b : d, "horiz.pix", "PIXELS", "horizontal");
        jD(f, "horiz.pct", "PERCENT", "horizontal");
        jD(c !== void 0 ? c : e, "vert.pix", "PIXELS", "vertical");
        jD(g, "vert.pct", "PERCENT", "vertical");
        vA("sdl", "pending", !1)
    }
      , jD = function(a, b, c, d) {
        var e = cD(b), f = {}, g;
      ...
      , kD = function() {
        ...
        return function() {
            var c = Qs()
              , d = c.height;
            a = Math.max(bD.scrollLeft + c.width, a);
            b = Math.max(bD.scrollTop + d, b);
            return {
                depthX: a,
                depthY: b,
                Il: a,
      ...
      , iD = function() {
        return !!(Object.keys(cD("horiz.pix")).length || Object.keys(cD("horiz.pct")).length || Object.keys(cD("vert.pix")).length || Object.keys(cD("vert.pct")).length)
    };
    function mD(a, b) {
        var c = this;
        K(this.getName(), ["options:!PixieMap", "triggerId:?*"], arguments);
        ...
        case "PIXELS":
            dD(d.horizontalThresholds, b, "horiz.pix");
            break;
        case "PERCENT":
            dD(d.horizontalThresholds, b, "horiz.pct")
        }
        switch (d.verticalThresholdUnits) {
        case "PIXELS":
            dD(d.verticalThresholds, b, "vert.pix");
            break;
        case "PERCENT":
            dD(d.verticalThresholds, b, "vert.pct")
        }
        uA("sdl", "init", !1) ? uA("sdl", "pending", !1) || F(function() {
            eD()
        }) : (vA("sdl", "init", !0),
        vA("sdl", "pending", !0),
        F(function() {
            ...
            if (iD()) {
                var e = hD();
                "onscrollend"in C ? (e = gD(),
                uc(C, "scrollend", e)) : uc(C, "scroll", e);
                uc(C, "resize", e)
            } else
                vA("sdl", "init", !1)
        }));
    ...
    var tD = function(a, b, c) {
      ...
      , wD = function(a, b) {
        ...
        function f(I) {
            ...
            case 1:
                ...
                y = a.getPlaybackRate();
                b.Ah ? hz(u.createEvent("start")) : u.zd();
                v = tD(b.ji, b.ii, a.getDuration());
                return g(I);
            default:
                return f
            }
        ...
        function k(I) {
            ...
            case 3:
                ...
                J = Math.abs((ob().getTime() - B) / 1E3 * y - H) > 1 ? "seek" : J || "buffering";
                a.getCurrentTime() && (b.zh ? hz(u.createEvent(J)) : u.zd());
                q();
                return m;
            case -1:
                return e(I);
        ...
        function n() {
            ...
            b.yh && hz(u.createEvent("complete", 1));
            return e(-1)
        }
        function p() {}
        function q() {
        ...
        function r() {
            if (v.length && y !== 0) {
                ...
                c = function() {
                    d = 0;
                    c = p;
                    v.length > 0 && v[0].Ha === J.Ha && (v.shift(),
                    hz(u.createEvent("progress", J.hf, J.lf)));
                    r()
                }
                ;
      ...
      , zD = function(a, b) {
        ...
        if (BD(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = c.indexOf("?") !== -1 ? "&" : "?";
                c.indexOf("origin=") > -1 ? d = c + e + "enablejsapi=1" : (rD || (rD = E.location.protocol + "//" + E.location.hostname,
                E.location.port && (rD += ":" + E.location.port)),
                d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(rD));
                var f;
                f = Ib(d);
                a.src = Jb(f).toString();
                return !0
      ...
      , BD = function(a, b) {
        ...
        for (var c = 0; c < qD.length; c++)
            if (a.indexOf("//" + qD[c] + "/" + b) >= 0)
                return !0;
        return !1
    }
      , AD = function() {
        var a = "" + Math.round(Math.random() * 1E9);
        return E.getElementById(a) ? AD() : a
    };
    function CD(a, b) {
        var c = this;
        var d = function() {
        ...
        var e = !!a.get("captureStart")
          ...
          , k = vD(G(a.get("progressThresholdsPercent")))
          , m = uD(G(a.get("progressThresholdsTimeInSeconds")))
        ...
        F(function() {
            for (var u = E.getElementsByTagName("script"), v = u.length, t = 0; t < v; t++) {
                ...
                if (BD(w, "iframe_api") || BD(w, "player_api"))
                    return b
            }
    ...
    function oF() {
        ...
        Q(43) && nF ? a = nF : (a.set("containerId", 'G-PNY6DMXXRP'),
        a.set("version", '1'),
    ...
    function IF(a, b) {
        ...
        var d = uj(Aj(C.location.href), "query")
          , e = tj(d, a, b);
        c = ed(e, this.D);
        return c
    }
